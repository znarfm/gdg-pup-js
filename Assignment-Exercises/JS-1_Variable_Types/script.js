...
// Using let
let name = "Nard"; // Define a string here, e.g., "Juan Cruz"
let age = 21; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["coding", "listening to music", "android modding"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
// Using const
const pi = Math.PI; // Define a number here, e.g., 3.14159
const birthYear = 2003; // Define a number here, e.g., 1990
const isEmployed = false; // Define a boolean here, e.g., true or false
const favoriteBooks = []; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
// Using var
var city = "Antipolo"; // Define a string here, e.g., "New York"
var temperature = 33; // Define a number here, e.g., 22.5
var hasPets = true; // Define a boolean here, e.g., true or false
var colors = ["black", "blue", "purple"]; // Define an array here, e.g., ["red", "green", "blue"]
